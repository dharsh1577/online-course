...
$course_id = 1; // Assuming course_id for Digital Marketing
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $name = $_POST['name'];
    $email = $_POST['email'];
    $course_id = 1; // Assuming "3D with Blender" has course_id = 1
...
<body>
    <div class="container hero-section">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1>Become a <span class="highlight">3D Artist</span> with Blender in 3 Months!</h1>
                <p class="text-black">Mentorship from industry experts at Pixar, DreamWorks, Ubisoft & more!</p>
                <p>Learn from top industry educators, work on hands-on projects, and gain <strong>job-ready skills</strong> to launch your career in 3D Art & Animation.</p>
                <img src="back2.png" alt="Machine Learning" class="img-fluid transparent-img mt-3">
            </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="course" name="course" value="3D with Blender" readonly>
...
<div class="col-md-6">
    ...
    <div class="course-card">
        ...
        <p>Learn 3D Art and Design with Blender</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">🖥️</span></h5>
        <p>Hands-on experience with Blender's 3D modeling tools</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">🎥</span></h5>
        <p>Lifetime Access to Recorded 3D Animation Sessions</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">💻</span></h5>
        <p>Access to Software and Resources for 3D Projects</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">📈</span></h5>
        <p>Project-based Learning to Enhance Your Portfolio</p>
    </div>
</div>
