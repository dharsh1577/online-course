...
$course_id = 4; // Assuming course_id for Digital Marketing
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $name = $_POST['name'];
    $email = $_POST['email'];
    $course_id = 4; // Assuming "Full Stack Development" has course_id = 4
...
<body>
    <div class="container hero-section">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1>Become a <span class="highlight">Full Stack Developer</span> in 6 Months!</h1>
                <p class="text-muted">Master front-end & back-end technologies and land your dream job!</p>
                <p>Learn full-stack development with the latest web technologies including HTML, CSS, JavaScript, Node.js, and more!</p>
                <img src="back4.png" alt="Machine Learning" class="img-fluid transparent-img mt-3">
            </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="course" name="course" value="Full Stack Developer" readonly>
    </div>
    <div class="mb-3">
...
<div class="col-md-6">
    ...
    <div class="course-card">
        <h5><span class="course-icon">🌐</span></h5>
        <p>Frontend with HTML, CSS, JavaScript & React</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">🗄️</span></h5>
        <p>Backend with Node.js, Express & Databases</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">☁️</span></h5>
        <p>Deploy Apps on Cloud Platforms</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">🚀</span></h5>
        <p>Build and Launch Real-world Projects</p>
    </div>
</div>
