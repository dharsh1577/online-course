...
<body>
    <div class="container hero-section">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1>Become a <span class="highlight">Digital Marketing Expert</span> in 3 Months!</h1>
                <p class="text-muted">Learn from top industry educators with practical insights!</p>
                <p>Master the skills of SEO, social media marketing, email campaigns, and more to jumpstart your career in Digital Marketing.</p>
                <img src="back3.png" alt="Machine Learning" class="img-fluid transparent-img mt-3">
            </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="course" name="course" value="Digital Marketing" readonly>
    </div>
    <div class="mb-3">
...
<div class="col-md-6">
    ...
    <div class="course-card">
        ...
        <p>Master Social Media & Digital Marketing Strategies</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">🎯</span></h5>
        <p>Learn SEO, Google Ads & Email Marketing</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">📊</span></h5>
        <p>Analyze Campaigns with Google Analytics</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">🛍️</span></h5>
        <p>Drive Sales with E-commerce & Affiliate Marketing</p>
    </div>
    <div class="course-card">
        <h5><span class="course-icon">📈</span></h5>
        <p>Grow Your Business with Data-Driven Marketing</p>
    </div>
</div>
